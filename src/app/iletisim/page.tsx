...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
            ...
            {/* Kariyer Alanı */}
            <div className="bg-[#061E4F]/5 p-8 rounded-2xl space-y-6">
              <div className="flex items-center space-x-4">
                <div className="bg-[#061E4F] p-3 rounded-lg">
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-light tracking-wider text-[#061E4F]">Kariyer</h3>
              </div>
              
              <p className="text-gray-600 font-light leading-relaxed">
                DOVEC İnşaat olarak, sürekli büyüyen ekibimize katılmak isteyen yetenekli profesyonelleri arıyoruz. 
                Açık pozisyonlarımız için özgeçmişinizi gönderebilirsiniz.
              </p>

              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <button 
                  onClick={() => window.location.href = 'mailto:kariyer@dovec.com'} 
                  className="inline-flex items-center justify-center px-6 py-3 bg-[#061E4F] text-white rounded-lg hover:bg-[#061E4F]/90 transition-colors group"
                >
                  <span>Özgeçmiş Gönder</span>
                  <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
                </button>
                <button 
                  onClick={() => window.location.href = '#acik-pozisyonlar'} 
                  className="inline-flex items-center justify-center px-6 py-3 border border-[#061E4F] text-[#061E4F] rounded-lg hover:bg-[#061E4F]/5 transition-colors"
                >
                  Açık Pozisyonlar
                </button>
              </div>
      ...
      {/* Açık Pozisyonlar */}
      <div id="acik-pozisyonlar" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extralight tracking-wider text-[#061E4F] mb-6">
            Açık Pozisyonlar
          </h2>
          <p className="text-lg text-gray-600 font-light max-w-3xl mx-auto">
            DOVEC İnşaat olarak, alanında uzman ve kendini geliştirmeye açık profesyonellerle çalışmaktan mutluluk duyuyoruz. 
            Aşağıdaki pozisyonlar için başvurularınızı bekliyoruz.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-medium text-[#061E4F]">İnşaat Mühendisi</h3>
              <span className="px-3 py-1 text-sm bg-[#061E4F]/10 text-[#061E4F] rounded-full">
                Tam Zamanlı
              </span>
            </div>
            ...
            <button 
              onClick={() => window.location.href = 'mailto:kariyer@dovec.com?subject=İnşaat Mühendisi Pozisyonu Başvurusu'} 
              className="w-full inline-flex items-center justify-center px-6 py-3 border border-[#061E4F] text-[#061E4F] rounded-lg hover:bg-[#061E4F] hover:text-white transition-colors group"
            >
              <span>Başvur</span>
              <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-medium text-[#061E4F]">Mimar</h3>
              <span className="px-3 py-1 text-sm bg-[#061E4F]/10 text-[#061E4F] rounded-full">
                Tam Zamanlı
              </span>
            </div>
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center text-gray-600">
                ...
                <span>2+ Yıl Deneyim</span>
              </div>
            </div>
            <button 
              onClick={() => window.location.href = 'mailto:kariyer@dovec.com?subject=Mimar Pozisyonu Başvurusu'} 
              className="w-full inline-flex items-center justify-center px-6 py-3 border border-[#061E4F] text-[#061E4F] rounded-lg hover:bg-[#061E4F] hover:text-white transition-colors group"
            >
              <span>Başvur</span>
              <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-medium text-[#061E4F]">Proje Müdürü</h3>
              <span className="px-3 py-1 text-sm bg-[#061E4F]/10 text-[#061E4F] rounded-full">
                Tam Zamanlı
              </span>
            </div>
            ...
            <button 
              onClick={() => window.location.href = 'mailto:kariyer@dovec.com?subject=Proje Müdürü Pozisyonu Başvurusu'} 
              className="w-full inline-flex items-center justify-center px-6 py-3 border border-[#061E4F] text-[#061E4F] rounded-lg hover:bg-[#061E4F] hover:text-white transition-colors group"
            >
              <span>Başvur</span>
              <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
