      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 relative flex flex-col">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-8 py-12">
          ...
          <div className="md:col-span-4 space-y-6">
            ...
            <p className="text-lg font-light tracking-wide text-[#061E4F] leading-snug">
            ...
            <div className="pt-4">
              <ul className="space-y-4">
                <li className="flex items-start group">
                  <svg className="h-6 w-6 mr-3 mt-1 text-[#061E4F] group-hover:text-[#061E4F] transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <a 
                    ...
                    className="text-base text-[#061E4F] hover:text-[#061E4F]/80 hover:translate-x-1 transition-all duration-300 tracking-wide"
                  >
                ...
                <li className="flex items-start group">
                  ...
                  <a 
                    ...
                    className="text-base text-[#061E4F] hover:text-[#061E4F] transition-all duration-300 tracking-wide"
                  >
                    +90 548 837 0015
                  </a>
                </li>
          ...
          <div className="md:col-span-4">
            <h3 className="text-lg font-medium tracking-wide uppercase mb-6 relative inline-block">
              Projelerimiz
              <div className="absolute -bottom-2 left-0 w-10 h-0.5 bg-[#061E4F]"></div>
            </h3>
            <ul className="space-y-4">
              <li>
                <Link href="/projeler/la-casalia" className="text-base text-[#061E4F] relative group/link tracking-wide">
              ...
              <li>
                <Link href="/projeler/four-seasons-life" className="text-base text-[#061E4F] relative group/link tracking-wide">
              ...
              <li>
                <Link href="/projeler/querencia" className="text-base text-[#061E4F] relative group/link tracking-wide">
                  <span className="relative inline-block transition-transform duration-300 group-hover/link:translate-x-2">Querencia</span>
                  <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#061E4F] transition-all duration-300 group-hover/link:w-full"></span>
                </Link>
              </li>
              <li>
                <Link href="/projeler/natulux" className="text-base text-[#061E4F] relative group/link tracking-wide">
                  <span className="relative inline-block transition-transform duration-300 group-hover/link:translate-x-2">Natulux</span>
                  <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#061E4F] transition-all duration-300 group-hover/link:w-full"></span>
                </Link>
              </li>
              <li>
                <Link href="/projeler/la-isla" className="text-base text-[#061E4F] relative group/link tracking-wide">
                  <span className="relative inline-block transition-transform duration-300 group-hover/link:translate-x-2">La Isla</span>
                  <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-[#061E4F] transition-all duration-300 group-hover/link:w-full"></span>
                </Link>
              </li>
              <li>
                <Link href="/projeler/courtyard-platinum" className="text-base text-[#061E4F] relative group/link tracking-wide">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/iletisim" className="text-base text-[#061E4F] relative group/link tracking-wide">
